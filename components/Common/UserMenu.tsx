    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-sky-200 transition-colors"
            aria-label="Close user menu cursor-pointer!"
          >
          ...
          <>
            ...
            <div className="border-t border-gray-100 p-2">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 hover:bg-red-50 transition-colors text-red-600 rounded-md"
              >
